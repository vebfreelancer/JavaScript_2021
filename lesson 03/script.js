...
// Добавляем условие если пользователь вводит текст ему выводится оповещение
// что необходимо ввести данные в цифром формате, после повторяем запрос ввода
if (addExpenses === Number) {
    addExpenses = true;
} else if (addExpenses !== Number) {
    confirm('Данные нужно ввести в числовом формате!');
